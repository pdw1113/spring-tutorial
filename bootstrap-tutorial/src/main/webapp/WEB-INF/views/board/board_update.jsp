		...
		<form action="/tutorial/board/write/complete" method="post" onsubmit="return regExp();">
			<div class="row mb-3">
				<div class="col-6 col-sm-3">
					...
					<input type="text" class="form-control" id="bWritter" placeholder="작성자 (6자리)" value="${board.bWritter}" readonly>
				</div>
				<div class="col-6 col-sm-3">
			...
			<div class="row mb-3">
				<div class="col">
					...
					<input type="text" class="form-control" id="bSubject" placeholder="제목을 입력해주세요. (16자리)" name="bSubject" value="${board.bSubject}">	
				</div>
			</div>
		    <div class="row mb-3">
				<div class="col">
